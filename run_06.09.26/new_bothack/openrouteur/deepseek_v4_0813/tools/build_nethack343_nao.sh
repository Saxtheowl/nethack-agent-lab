...
# NAO ships HACKDIR=/nh343, VAR_PLAYGROUND=/nh343/var
...
# Makefile.src: modern gcc + link ncurses
...
# no bison/flex: use NetHack's pre-generated parsers (byte-identical to 3.4.3)
