...
from .monster import guard, shopkeeper
...
def pass_monster(game, level, to_tile, dir_, monster, opts):
    ...
    if not opts.get('no-fight'):
        return (2 if at_planes(game) else 12,
...
def reset_exploration(bh):
    ...
    def about_to_choose(game):
        ...
        bh.game.swap(assoc, 'explore-cache', _curlvl_exploration(game))
